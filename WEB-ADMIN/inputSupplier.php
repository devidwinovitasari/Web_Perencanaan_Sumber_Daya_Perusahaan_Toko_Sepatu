...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if (isset($_POST['nama_supplier'], $_POST['nama_barang'], $_POST['alamat_supplier'], $_POST['email_supplier'], $_POST['kode_pos'], $_POST['no_telp'], $_POST['no_rek'])) {
        ...
        $query = "INSERT INTO supplier (nama_supplier, nama_barang, alamat_supplier, email_supplier, kode_pos, no_telp, no_rek) 
                  VALUES ('$nama_supplier', '$nama_barang', '$alamat_supplier', '$email_supplier', '$kode_pos', '$no_telp', '$no_rek')";
