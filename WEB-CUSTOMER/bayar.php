...
// Inisialisasi $nama sebagai string kosong
$nama = '';
...
// Hitung diskon berdasarkan total harga belanja
$diskon = 'Tidak Ada Diskon';
if ($total_harga > 3000000) {
    $diskon = 'Diskon 20%';
            ...
            <div class="box-inner-2">
                ...
                <form action="sukses.php" method="post">
                    <div class="mb-3">
                        ...
                        <input class="form-control" type="text" id="nama" name="nama" placeholder="Nama Pemesan" value="<?php echo htmlspecialchars($nama); ?>">
                    </div>
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                        ...
                        <input id="namaBarangInput" class="form-control" type="text" name="nama_barang" value="<?php echo htmlspecialchars($nama_barang); ?>" readonly>
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <input id="diskonInput" class="form-control" type="text" name="diskon" value="<?php echo htmlspecialchars($diskon); ?>" readonly>
                    </div>
